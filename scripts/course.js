...
function renderCourses(courseList) {
  ...
  courseList.forEach(course => {
    ...
    // Add either .completed or .not-completed
    if (course.completed) {
    ...
    // Only show subject + number
    div.textContent = `${course.subject} ${course.number}`;
    coursesContainer.appendChild(div);
  });


   // ✅ show total number of displayed courses
  totalContainer.textContent = `The total number of courses listed below is: ${courseList.length}`;
}
